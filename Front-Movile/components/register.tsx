...
export default function Register({ onSubmit, onLoginPress }: RegisterProps) {
  ...
  return (
    <View style={styles.screen}>
      <View style={styles.card}>
        <Text style={styles.eyebrow}>Comienza aquí</Text>
        <Text style={styles.title}>Crea tu cuenta</Text>
        <Text style={styles.subtitle}>Solo necesitas un correo y una contraseña.</Text>
        <View style={styles.form}>
          ...
          <Pressable style={styles.primaryButton} onPress={() => onSubmit({ email, password })}>
            <Text style={styles.primaryButtonText}>Registrarme</Text><ArrowRight size={18} color="#ffffff" />
          </Pressable>
        </View>
        <View style={styles.switchRow}><Text style={styles.muted}>¿Ya tienes una cuenta?</Text><Pressable onPress={onLoginPress}><Text style={styles.link}>Inicia sesión</Text></Pressable></View>
      </View>
    </View>
  );
}
